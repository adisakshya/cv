...
%---------------------------------------------------------
  \cventry
    {Ansible, Jenkins, Kubernetes, AWS, Elasticsearch, Logstash, Kibana, Docker, Nginx, PostgreSQL, Tensorflow} % Job title
...
%---------------------------------------------------------
  \cventry
    {Python, Tensorflow, Natural Language Processing, AIML, Speech-to-text, Text-to-speech} % Job title
